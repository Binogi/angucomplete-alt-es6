...
const angucompleteAltModule = angular.module('angucomplete-alt', [])

angucompleteAltModule.directive(
    'angucompleteAlt',
    [
        '$q',
        '$parse',
        ...
        function ($q, $parse, $http, $sce, $timeout, $templateCache, $interpolate) {
          ...
          */
                ...
                function getLocalResults (str) {
                    var i; var match; var s; var value
...
export default angucompleteAltModule.name
